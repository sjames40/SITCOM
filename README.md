...
```
The threshold may vary depending on the task; for instance, in super-resolution, it is set to 28, whereas for phase retrieval, it is 1020, other image task is 540. as it depends on the image size.
