...
## 📢 News & Updates
* **[April 2026]** 🔥 Added a new demo notebook [`Demo_for_sr_inpainting.ipynb`](./Demo_for_sr_inpainting.ipynb) for Super-Resolution (SR) and Inpainting visualization. We've also updated `SITCOM_with_noise.py` and `inpainting_config.yaml`(in configs folder) to fully support this demo.
...
we will refer to another repo on [SITCOM-ODE](https://github.com/sjames40/SITCOM_ODE).
