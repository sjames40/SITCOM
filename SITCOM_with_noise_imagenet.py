...
model_config='/home/diffusion_github_code/Measurment_Consistent_Diffusion_Trajectory/configs/imagenet_model_config.yaml'
diffusion_config='/home/diffusion_github_code/Measurment_Consistent_Diffusion_Trajectory/configs/diffusion_config.yaml'
task_config= '/home/diffusion_github_code/Measurment_Consistent_Diffusion_Trajectory/configs/motion_deblur_config.yaml'
...
gt_img = Image.open('/home/shijun.liang/github_code/diffusion-posterior-sampling-main/imagenet/ILSVRC2012_val_00001185.JPEG').convert("RGB")
...
plt.axis('off')
plt.savefig("imagenet009_check2.png", dpi=300,bbox_inches='tight', pad_inches=0)
plt.colorbar()
