...
class PreviousXMeanProcessor(MeanProcessor):
    def __init__(self, betas, dynamic_threshold, clip_denoised):
        ...
        #self.sqrt_one_minus_alpha_cumprod = np.sqrt(1 - alphas_cumprod)
        #self.sqrt_alpha_cumprod = np.sqrt(sqrt_alpha_cumprod)
    ...
    def predict_xstart(self, x_t, t, x_prev):
        ...
        #pred_x0 = (x_prev -self.sqrt_one_minus_alpha_cumprod * x_t) / self.sqrt_alpha_cumprod 
...
class EpsilonXMeanProcessor(MeanProcessor):
    def __init__(self, betas, dynamic_threshold, clip_denoised):
        ...
        self.posterior_mean_coef2 = (1.0 - alphas_cumprod_prev) * np.sqrt(alphas) / (1.0 - alphas_cumprod)
        #self.sqrt_one_minus_alpha_cumprod = np.sqrt(1 - alphas_cumprod)
        #self.sqrt_alpha_cumprod = np.sqrt(alpha_cumprod)
    ...
    def predict_xstart(self, x_t, t, eps):
        ...
        #coef1 = extract_and_expand(sqrt_one_minus_alpha_cumprod,t,eps)
        #coef2 = extract_and_expand(sqrt_recip_alphas_cumprod,t,x_t)
